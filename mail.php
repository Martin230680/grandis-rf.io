...
try {
  ...
  $mail->Username   = 'grandisrf@yandex.ru'; // Логин на почте
  $mail->Password   = 'grhevrhdbplizigd'; // Пароль на почте
  $mail->SMTPSecure = 'ssl';
  $mail->Port       = 465;

  $mail->setFrom('grandisrf@yandex.ru', 'Заявка с сайта'); // Адрес самой почты и имя отправителя

  // Получатель письма
  $mail->addAddress('martinmusorka@yandex.ru');
